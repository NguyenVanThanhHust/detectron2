...
from .object_roi_heads import build_object_roi_head
...
class CustomROIHeads(StandardROIHeads): 
    ...
    def forward(self, images, features, proposals, targets=None):
        ...
        if self.training:
            ori_losses = self._forward_box(features, proposals)
            object_losses = self._forward_object(features, proposals)
            losses.update(ori_losses)
